...
import com.shangguigu.shangyitong.cmn.client.DictFeignClient;
import com.shangguigu.shangyitong.hosp.repository.HospitalRepository;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        String mapString = JSONObject.toJSONString(paramMap);//转成字符串
        Hospital hospital = JSONObject.parseObject(mapString, Hospital.class);//转成对象
